...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const enableScatterPlot = document.getElementById("enableScatterplot") as HTMLInputElement;
  ...
  tableau.extensions.initializeDialogAsync().then(() => {
    ...
    const settingsObj =
      "settings" in currentSettings
        ...
        : { tooltipsEnabled: true, enableYAxis: false, enableRandomSize: false, enableScatterPlot: false };
    ...
    enableScatterPlot.checked = settingsObj?.enableScatterPlot;
    ...
    saveButton.addEventListener("click", () => {
      tableau.extensions.settings.set(
        ...
        JSON.stringify({
          ...
          enableScatterPlot: enableScatterPlot.checked,
        })
      );
